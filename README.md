...
| Draw Communication                           | Bool   | If enabled uses Unity Gizmos to draw lines between communicating agents when the communicate (Can only be seen inside Unity Editor with Gizmos enabled)                                                                                                                                                                                                                                                                                                             |
| Show Environment Tags                        | Bool   | If enabled draws the environment tags as Gizmos                                                                                                        (Can only be seen inside Unity Editor with Gizmos enabled)                                                                                                                                                                                                                                                   |
| Should Write CSV Results                     | Bool   | If enabled statistics are written to CSV files whenever a simulation is finishes (Not when  the simulator is closed manually)                                                                                                                                                                                                                                                                                                                                       |
