    ...
    public class SlamMap : SlamAlgorithmInterface, IPathFindingMap{
       ...
       public Dictionary<Vector2Int, SlamTileStatus> GetExploredTiles() {
        ...
        public bool IsOptimisticSolid(Vector2Int coordinate) {
            ...
            // TODO: IMPORTANT! We offset this due to the tiles not aligning with the obstacles generated by the map. There should be a better way.
            // slamCoordinate = new Vector2Int(slamCoordinate.x - 1, slamCoordinate.y - 1);
            ...
            if (IsWithinBounds(slamCoordinate)) {
                ...
                if (!IsWithinBounds(new Vector2Int(slamCoordinate.x + 1, slamCoordinate.y))) return true;
                ...
                if (!IsWithinBounds(new Vector2Int(slamCoordinate.x, slamCoordinate.y + 1))) return true;
                ...
                if (!IsWithinBounds(new Vector2Int(slamCoordinate.x + 1, slamCoordinate.y + 1))) return true;
        ...
        public List<Vector2Int> GetOptimisticPath(Vector2Int slamTileFrom, Vector2Int slamTileTo) {
            var path = _pathFinder.GetOptimisticPath(slamTileFrom, slamTileTo, this)
